...
const DupaPreview = ({ open, cancel, content, dupa, equipmentSource }) => {
  ...
  useEffect(() => {
    if (open && content) {
      const filtered_data = [];
      const export_data = [];
      const labor_content = content.dupa_content.dupa_labor.map(
        (item, index) => {
          filtered_data.push({
            item: "",
      ...
      const equipment_content = content.dupa_content.dupa_equipment.map(
        (item, index) => {
          filtered_data.push({
            item: "",
      ...
      const material_content = content.dupa_content.dupa_material.map(
        (item, index) => {
          filtered_data.push({
            item: "",
      ...
      export_data.push(
        ...
        {
          item: "Item Code: " + content.dupa_content.dupa.item_number,
          designation: null,
          group: null,
          number_of_person: null,
          number_of_hour: null,
        ...
        {
          item: "Destription: " + content.dupa_content.dupa.description,
          designation: null,
          group: null,
          number_of_person: null,
          number_of_hour: null,
        ...
        {
          item: "Output/Hr.: " + content.dupa_content.dupa.output_per_hour,
          designation: null,
          group: null,
          number_of_person: null,
          number_of_hour: null,
      ...
      content.dupa_content.dupa_labor.map((item, index) => {
        export_data.push({
          item: "",
          designation: item.designation,
          group: item.group,
      ...
      content.dupa_content.dupa_equipment.map((item, index) => {
        export_data.push({
          item: "",
          designation: item.name,
          group: "",
      ...
      content.dupa_content.dupa_material.map((item, index) => {
        export_data.push({
          item: "",
          designation: item.name,
          group: "",
  ...
  const handleOk = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, content.dupa_content.dupa.item_number);
    XLSX.writeFile(wb, content.dupa_content.dupa.item_number + ".xlsx");
  };
  ...
  return (
    ...
    >
      {!content ? (
        ...
        <div>
          <div>
            <h3> Item Code: {content.dupa_content.dupa.item_number}</h3>
            <h3> Description: {content.dupa_content.dupa.description}</h3>
            <h3> Unit: {dupa?.abbreviation} </h3>
            <h3> Output/Hr.: {content.dupa_content.dupa.output_per_hour} </h3>
          </div>
          <br />
          <Table
            columns={columns}
